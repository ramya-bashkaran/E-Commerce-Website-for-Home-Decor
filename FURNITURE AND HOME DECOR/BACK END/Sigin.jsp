...
java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/india","root","nisha@12345");
Statement st= con.createStatement();
ResultSet rs=st.executeQuery("select * from final where username='"+username+"' and password='"+password+"'");
try{
rs.next();
